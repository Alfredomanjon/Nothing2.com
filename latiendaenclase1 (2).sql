...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2019 a las 17:57:32
...
--
CREATE DATABASE IF NOT EXISTS `latiendaenclase1` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pedidos_detail` (
  `Id_localizador` int(11) NOT NULL AUTO_INCREMENT,
